...
|-------|-------------|--------|-------------|---------------|-------------|
| Seq2Point | `original_seq2point` | seq2point | point | 599 | Baseline 5-layer CNN |
...
|-------|-------------|-------------|----------------------|----------------|
| Seq2Point / Seq2Point_Reduced / Seq2Point_Balanced | `model_pipeline/models/seq2point/cnn.py` | `original_seq2point`, `reduced_seq2point`, `balanced_seq2point` | `https://github.com/MingjunZhong/seq2point-nilm` | Zhong, M., Goddard, N., Sutton, C., and Gillian, C. (2018). *Sequence-to-point learning with neural networks for non-intrusive load monitoring*. AAAI. |
| Seq2Point_LSTM | `model_pipeline/models/seq2point/rnn.py` | `legacy_lstm_seq2point` | Implemented for this project | Zhong, M., Goddard, N., Sutton, C., and Gillian, C. (2018). *Sequence-to-point learning with neural networks for non-intrusive load monitoring*. AAAI. |
...
| RNN / WindowGRU / BiLSTM | `model_pipeline/models/seq2point/rnn.py` | `rnn`, `window_gru`, `bilstm` | Related baseline collection: `https://github.com/nilmtk/nilmtk-contrib` | Kelly, J., and Knottenbelt, W. (2015). *Neural NILM: Deep Neural Networks Applied to Energy Disaggregation*. BuildSys. Batra, N. et al. (2019). *Towards Reproducible State-of-the-Art Energy Disaggregation*. BuildSys. |
| DAE | `model_pipeline/models/seq2seq/autoencoder.py` | `dae` | Related baseline collection: `https://github.com/nilmtk/nilmtk-contrib` | Kelly, J., and Knottenbelt, W. (2015). *Neural NILM: Deep Neural Networks Applied to Energy Disaggregation*. BuildSys. Batra, N. et al. (2019). *Towards Reproducible State-of-the-Art Energy Disaggregation*. BuildSys. |
